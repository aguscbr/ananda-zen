    ...
    <div className={styles.contactSection__container}>
      ...
      >
        ...
        <p className={styles.contactSection__description}>
          Escribinos y te contamos todo sobre nuestras clases.
        </p>
      </motion.div>
      ...
      <div className={styles.contactSection__grid}>
        ...
        >
          ...
          <button className={styles.contactSection__button}>
            Enviar mensaje
          </button>
        </motion.form>
        ...
        >
          {[
            ...
            <div
              key={item.label}
              className={styles.contactSection__contactItem}
            >
              <div className={styles.contactSection__iconWrapper}>
                <item.icon className={styles.contactSection__icon} />
              </div>
              <div>
                <p className={styles.contactSection__contactLabel}>
                  {item.label}
                </p>
                <p className={styles.contactSection__contactValue}>
                  {item.value}
                </p>
              </div>
            </div>
